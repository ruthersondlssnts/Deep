...
public partial class AddPasswordConfiguration : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                changed_at_utc = table.Column<DateTime>(
                    type: "timestamp with time zone",
                    nullable: false
                ),
            },
            constraints: table => table.PrimaryKey("pk_password_histories", x => x.id)
        );
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                used_at_utc = table.Column<DateTime>(
                    type: "timestamp with time zone",
                    nullable: true
                ),
            },
    ...
    {
        migrationBuilder.DropTable(name: "password_histories", schema: "accounts");

        migrationBuilder.DropTable(name: "password_reset_tokens", schema: "accounts");
