...
public partial class Initial : Migration
{
    ...
    {
        migrationBuilder.EnsureSchema(name: "programs");
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                starts_at_utc = table.Column<DateTime>(
                    type: "timestamp with time zone",
                    nullable: false
                ),
                ends_at_utc = table.Column<DateTime>(
                    type: "timestamp with time zone",
                    nullable: false
                ),
    ...
    {
        migrationBuilder.DropTable(name: "program_assignments", schema: "programs");

        migrationBuilder.DropTable(name: "programs", schema: "programs");

        migrationBuilder.DropTable(name: "users", schema: "programs");
    }
}
