...
public partial class OutboxInbox : Migration
{
    ...
    {
        migrationBuilder.DropTable(name: "inbox_message_consumers", schema: "programs");

        migrationBuilder.DropTable(name: "inbox_messages", schema: "programs");

        migrationBuilder.DropTable(name: "outbox_message_consumers", schema: "programs");

        migrationBuilder.DropTable(name: "outbox_messages", schema: "programs");
    }
}
