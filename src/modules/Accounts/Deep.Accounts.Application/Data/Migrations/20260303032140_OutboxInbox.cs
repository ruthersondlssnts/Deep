...
public partial class OutboxInbox : Migration
{
    ...
    {
        migrationBuilder.DropTable(name: "inbox_message_consumers", schema: "accounts");

        migrationBuilder.DropTable(name: "inbox_messages", schema: "accounts");

        migrationBuilder.DropTable(name: "outbox_message_consumers", schema: "accounts");

        migrationBuilder.DropTable(name: "outbox_messages", schema: "accounts");
    }
}
