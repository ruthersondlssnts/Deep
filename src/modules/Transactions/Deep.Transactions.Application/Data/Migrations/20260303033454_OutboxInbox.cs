...
public partial class OutboxInbox : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
                table.PrimaryKey(
                    "pk_inbox_message_consumers",
                    x => new { x.inbox_message_id, x.name }
                )
        );
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
                table.PrimaryKey(
                    "pk_outbox_message_consumers",
                    x => new { x.outbox_message_id, x.name }
                )
        );
    ...
    {
        migrationBuilder.DropTable(name: "inbox_message_consumers", schema: "transactions");

        migrationBuilder.DropTable(name: "inbox_messages", schema: "transactions");

        migrationBuilder.DropTable(name: "outbox_message_consumers", schema: "transactions");

        migrationBuilder.DropTable(name: "outbox_messages", schema: "transactions");
    }
}
