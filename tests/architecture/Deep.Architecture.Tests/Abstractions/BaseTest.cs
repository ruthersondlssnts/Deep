...
{
    protected const string AccountsNamespace = "Deep.Accounts";
    protected const string AccountsIntegrationEventsNamespace = "Deep.Accounts.IntegrationEvents";

    protected const string ProgramsNamespace = "Deep.Programs";
