...
using Vast.Accounts.Application.Features.Authentication;
using Vast.Accounts.Application.Features.Passwords;
using Vast.Accounts.Domain.Accounts;
using Vast.Common.Domain;

namespace Vast.Accounts.Application.Tests.Accounts;
